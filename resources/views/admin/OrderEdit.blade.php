    ...
    <div class="box-header with-border">
        ...
        <div class="box-tools">
            <div class="btn-group pull-right" style="margin-right: 10px">
                <a class="btn btn-sm btn-default" href="/admin/shop_order"><i class="fa fa-list"></i>&nbsp;List</a>
            </div>
            <div class="btn-group pull-right" style="margin-right: 10px">
                <a class="btn btn-sm btn-default form-history-back" href="/admin/shop_order"><i class="fa fa-arrow-left"></i>&nbsp;Back</a>
            </div>
        </div>
    </div>
    <div>
       <table class="table box table-bordered">
        <tr>
          <th style="width: 200px">Thông tin người nhận:</th>
            <td>
                <a href="#" class="updateInfoRequired" data-name="toname" data-type="text" data-pk="{{ $order->id }}" data-url="{{ route("order_update") }}" data-title="Thông tin người nhận" >{{ $order->toname }}</a>
            </td>
        </tr>
        <tr>
